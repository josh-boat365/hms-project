            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="./nurse-dash.php"><i class="fe fe-home"></i> <span>Dashboard</span></a>
                        </li>
                        <li>
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Welcome To The Patients Lobby</h3>
                            <ul class="breadcrumb">
                ...
                <!-- <div class="pat-app d-flex justify-content-center align-items-center border" style=" width:100%;"> -->
                <div class="row">
